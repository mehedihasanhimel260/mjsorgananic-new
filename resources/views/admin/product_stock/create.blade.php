...
<section class="section main-section">
    <div class="card">
        ...
        <div class="card-content">
            <form method="post" action="{{ route('admin.product-stocks.store') }}">
                @csrf
                <div class="field">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="number" step="0.01" name="total_cost" placeholder="Total Cost" required>
                    </div>
                </div>
                <div class="field">
